...
filename="/content/drive/MyDrive/practice/IPL_model.joblib"
...
batting_team= st.selectbox('Select the Batting Team ',('Chennai Super Kings', 'Delhi Capitals', 'Punjab Kings','Kolkata Knight Riders','Mumbai Indians','Rajasthan Royals','Royal Challengers Bangalore','Sunrisers Hyderabad','Gujrat Titans','Lucknow Super Giants'))
...
bowling_team = st.selectbox('Select the Bowling Team ',('Chennai Super Kings', 'Delhi Capitals', 'Punjab Kings ','Kolkata Knight Riders','Mumbai Indians','Rajasthan Royals','Royal Challengers Bangalore','Sunrisers Hyderabad','Gujrat Titans','Lucknow Super Giants'))
